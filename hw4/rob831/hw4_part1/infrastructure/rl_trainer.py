...
class RL_Trainer(object):
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            obs_batch, acs_batch, rews_batch, next_obs_batch, terminals_batch = self.agent.sample(self.params['train_batch_size'])
            
            train_log = self.agent.train(obs_batch, acs_batch, rews_batch, next_obs_batch, terminals_batch)
    ...
    def train_sac_agent(self):
        ...
        for _ in range(self.sac_params['num_agent_train_steps_per_iter']):
            ob, ac, rew, next_ob, terminal = self.agent.sample_sac(self.sac_params['train_batch_size'])
            self.agent.train_sac(ob, ac, rew, next_ob, terminal)
